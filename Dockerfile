FROM debian:jessie
MAINTAINER dafalcon <danfalcone@gmail.com>

# Adapted from https://hub.docker.com/r/vimagick/casperjs/~/dockerfile/
...
COPY ./casper_ynab.js /app/

ENTRYPOINT ["/usr/local/bin/casperjs", "/app/casper_ynab.js"]
